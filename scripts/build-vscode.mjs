...
function theme(scheme) {
    ...
    const colors = {
        ...
        "editorBracketHighlight.foreground6": t("badge-experimental"),
        ...
        "symbolIcon.classForeground": t("accent"),
        "symbolIcon.interfaceForeground": t("accent"),
        "symbolIcon.enumeratorForeground": t("accent"),
        "symbolIcon.structForeground": t("accent"),
        "symbolIcon.eventForeground": t("accent"),
        "symbolIcon.functionForeground": t("badge-experimental"),
        "symbolIcon.methodForeground": t("badge-experimental"),
        "symbolIcon.constructorForeground": t("badge-experimental"),
        "symbolIcon.constantForeground": t("badge-experimental"),
        "symbolIcon.enumeratorMemberForeground": t("badge-experimental"),
    ...
    /* Syntax: slate for structure, bold text-heading for defined names, accent for keywords, violet for literals. */
    const tokenColors = [
        { scope: ["comment", "punctuation.definition.comment"],
            settings: { foreground: t("text-tertiary"), fontStyle: "italic" } },
        { scope: ["string", "punctuation.definition.string"],
            settings: { foreground: t("badge-experimental") } },
    ...
    const semanticTokenColors = {
        "namespace": t("text-heading"),
        "class": bold("text-heading"),
        "interface": bold("text-heading"),
        "enum": bold("text-heading"),
        "struct": bold("text-heading"),
        "type": bold("text-heading"),
        "typeParameter": bold("text-heading"),
        "function": bold("text-heading"),
        "method": bold("text-heading"),
        "macro": t("accent"),
        "keyword": t("accent"),
        "comment": { foreground: t("text-tertiary"), italic: true },
        "string": t("badge-experimental"),
        "number": t("badge-experimental"),
        "regexp": t("badge-experimental"),
        "enumMember": t("badge-experimental"),
